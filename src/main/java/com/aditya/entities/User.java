...
@Entity
@Table // if you want table name to something different than class name you can do it
		// like @Table (name = "another_name")
public class User { // User will be the name of the table
	...
	@GeneratedValue(strategy = GenerationType.IDENTITY) // THIS WILL HELP IN AUTOMATIC GENERATION OF IDs
